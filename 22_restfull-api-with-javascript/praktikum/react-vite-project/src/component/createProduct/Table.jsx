...
import { API_BASE_URL, PRODUCTS_ENDPOINT } from '../../apis/productAPI';
...
function Table() {
    ...
    const deleteProduct = async (productId) => {
        try {
            const response = axios.delete(`${API_BASE_URL}${PRODUCTS_ENDPOINT}/${productId}`)
    ...
    // Edit Product
    const editProduct = async (productId, editDataProduct) => {
        try {
            const response = axios.put(`${API_BASE_URL}${PRODUCTS_ENDPOINT}/${productId}`, editDataProduct)
            window.location.reload();
    ...
    const saveChanges = () => {
        ...
        editProduct(selectedProductId, editedProduct);
