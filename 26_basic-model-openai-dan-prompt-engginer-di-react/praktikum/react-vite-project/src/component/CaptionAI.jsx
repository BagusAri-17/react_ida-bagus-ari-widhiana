    ...
    const handleApiKey = async () => {
        ...
        try {
            ...
            const chatCompletion = await openai.chat.completions.create({
                messages: [{role: 'system', content:'You will be given a prompt, and your task is to create a caption for a social media post based on the given prompt.'}, { role: 'user', content: prompt }],
                model: 'gpt-3.5-turbo',
                temperature: 0,
                max_tokens: 1024,
            });
        ...
        <div className='container'>
            <div className='max-w-[600px] lg:max-w-[800px] mx-auto'>
                ...
                <div className='mt-4 text-center'>
                    <h1 className='text-4xl font-bold text-gray-900'>CAPTION AI</h1>
                    ...
                    <p className='text-sm mt-4 text-gray-900 font-semibold'>Generate Caption For Social Media</p>
                </div>
                <div className='mt-8'>
